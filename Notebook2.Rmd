...
pca_cluster_data <- pca_data %>%
  mutate(Cluster = final_kmeans$cluster,
         ...
         GoalsAssists = full_data$Goals + full_data$Assists)  # Assuming 'full_data' has 'Pos' column
...
For this we will would assume that the number of optimal clusters is the same as we calculated before in K-means. But to check we will calculate the Silhouette Score and the Gap Statistic.
